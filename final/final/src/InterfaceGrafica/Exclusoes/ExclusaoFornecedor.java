...
public class ExclusaoFornecedor extends JFrame {
    JComboBox<Fornecedor> exclusao = new JComboBox<>();
    JButton btn1 = new JButton();
    private static Fornecedor item_selecionado;

    public ExclusaoFornecedor(){
        setTitle("Exclusão de Fornecedor");
        setVisible(true);
        setSize(800, 500);
        setResizable(false);
        ...
        JLabel titulo = new JLabel("Exclusão de Fornecedor");
    ...
    public void btn1(ActionEvent ActionEvent){
        item_selecionado = (Fornecedor) exclusao.getSelectedItem();
