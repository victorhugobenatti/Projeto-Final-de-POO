...
public class ExclusaoEndereco extends JFrame {
    JComboBox<Endereco> exclusao = new JComboBox<>();
    JButton btn1 = new JButton();
    private static Endereco item_selecionado;

    public ExclusaoEndereco(){
        setTitle("Exclusão de Endereços");
        setVisible(true);
        setSize(800, 500);
        setResizable(false);
        ...
        JLabel titulo = new JLabel("Exclusão de Endereços");
    ...
    public void btn1(ActionEvent ActionEvent){
            item_selecionado = (Endereco) exclusao.getSelectedItem();
