...
public class AlteracaoContaReceber extends JFrame {
    JComboBox<ContaReceber> alteracao;
    ...
    public AlteracaoContaReceber(){
        setTitle("Alteração de Contas à Receber");
        setVisible(true);
        setSize(800, 500);
        setResizable(false);
        ...
        JLabel titulo = new JLabel("Alteração de Contas à Receber");
        ...
        for(ContaReceber contaReceber : App.ContasReceber ){
            alteracao.addItem(contaReceber);
        }
        add(alteracao);
    ...
    public void btn1(ActionEvent ActionEvent){
        try {
            item_selecionado = (ContaReceber) alteracao.getSelectedItem();
            txt1.setText("Atual:");
            txt2.setText("Novo:");
            add(txtfield);
