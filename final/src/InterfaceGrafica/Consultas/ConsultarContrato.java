...
public class ConsultarContrato extends JFrame {
    JComboBox<Contrato> consulta = new JComboBox<>();
    ...
    public ConsultarContrato(){
        ...
        JLabel titulo = new JLabel("Consulta de Contratos");
    ...
    public void btn1(ActionEvent ActionEvent){
        try {
            item_selecionado = (Contrato) consulta.getSelectedItem();

            txt1.setBounds(20, 130, 700, 20);
            txt1.setText("ID-Contrato: " + item_selecionado.getIdContrato());

            txt2.setBounds(20, 160, 700, 20);
            txt2.setText("Prazo de vigência: " + item_selecionado.getPrazo());
        }
        catch(Exception e) {
