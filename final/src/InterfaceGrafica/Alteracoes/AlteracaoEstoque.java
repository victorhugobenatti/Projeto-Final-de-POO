...
public class AlteracaoEstoque extends JFrame {
    JComboBox<Estoque> alteracao;
    ...
    public AlteracaoEstoque(){
        ...
        JLabel titulo = new JLabel("Alteração de Estoque");
        ...
        campoAlterar.addItem("Quantidade");
    ...
    public void btn1(ActionEvent ActionEvent){
        try {
            item_selecionado = (Estoque) alteracao.getSelectedItem();
            txt1.setText("Atual:");
            txt2.setText("Novo:");
            add(txtfield);

            txt3.setText(Integer.toString(item_selecionado.getQuantidade()));
        }
        catch(Exception e){
    ...
    public void btn2(ActionEvent ActionEvent){
        try {
            ...
            try {
                ...
                item_selecionado.setQuantidade(parseInt);
