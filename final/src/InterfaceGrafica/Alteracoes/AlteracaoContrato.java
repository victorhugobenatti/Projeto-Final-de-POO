...
public class AlteracaoContrato extends JFrame {
    JComboBox<Contrato> alteracao;
    ...
    private static Contrato item_selecionado;

    public AlteracaoContrato(){
        ...
        JLabel titulo = new JLabel("Alteração de Contrato");
    ...
    public void btn1(ActionEvent ActionEvent){
        try {
            item_selecionado = (Contrato) alteracao.getSelectedItem();
            txt1.setText("Atual:");
            txt2.setText("Novo:");
            add(txtfield);

            txt3.setText(Integer.toString(item_selecionado.getPrazo()));
        }
        catch(Exception e){
    ...
    public void btn2(ActionEvent ActionEvent){
        try {
            ...
            try {
                ...
                item_selecionado.setPrazo(parseInt);
