...
public class AlteracaoMaquina extends JFrame {
    JComboBox<Maquina> alteracao;
    ...
    public AlteracaoMaquina(){
        ...
        JLabel titulo = new JLabel("Alteração de Máquina");
        ...
        campoAlterar.addItem("Data da Compra");
    ...
    public void btn1(ActionEvent ActionEvent){
        try {
            item_selecionado = (Maquina) alteracao.getSelectedItem();
            txt1.setText("Atual:");
            txt2.setText("Novo:");
            add(txtfield);
            ...
            switch ((String) campoAlterar.getSelectedItem()) {
                case "Data da Compra":
                    txt3.setText(item_selecionado.getDtaCompra());
                    break;
    ...
    public void btn2(ActionEvent ActionEvent) {
        try {
            ...
            switch ((String) campoAlterar.getSelectedItem()) {
                case "Data da Compra":
                    item_selecionado.setDtaCompra(txtfield.getText());
                    break;
