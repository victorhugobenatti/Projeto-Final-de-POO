...
import InterfaceGrafica.Cadastros.CadastroCliente;
import InterfaceGrafica.Cadastros.CadastroFornecedor;
import InterfaceGrafica.Cadastros.CadastroFuncionario;

import javax.swing.*;
import java.awt.*;
import java.awt.event.ActionEvent;

public class EscolhaDePessoaAlteracao extends JFrame {

    public EscolhaDePessoaAlteracao(){
    ...
    private void Funcionario(ActionEvent actionEvent){
        new AlteracaoFuncionario();

    }

    private void Fornecedor(ActionEvent actionEvent){
        new AlteracaoFornecedor();
