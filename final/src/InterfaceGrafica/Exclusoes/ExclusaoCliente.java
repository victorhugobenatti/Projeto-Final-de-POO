...
public class ExclusaoCliente extends JFrame {
    JComboBox<Cliente> exclusao = new JComboBox<>();
    ...
    public ExclusaoCliente(){
        ...
        JLabel titulo = new JLabel("Exclusão de Clientes");
    ...
    public void btn1(ActionEvent ActionEvent){
        item_selecionado = (Cliente) exclusao.getSelectedItem();

        if(item_selecionado!=null) {
            App.Clientes.remove(item_selecionado);
